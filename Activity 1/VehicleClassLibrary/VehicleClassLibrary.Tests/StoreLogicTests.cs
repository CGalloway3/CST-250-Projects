...
namespace VehicleClassLibrary.Tests
{
    public class StoreLogicTests
    {
        ...
        {
            // Arrange: Create an instance of StoreLogic (Sysyem under Test - SUT)
            ...
            // Assert: Verify that the vehicle was added to the inventory
            Assert.Contains(car, inventory);
        }

        // Test forGetInventory when no vehicles have been added
        [Fact]
        public void GetInventory_ShouldReturnEmptyList_WhenNoVehiclesAdded()
        {
            ...
            // Assert: Verify that the inventory is empty
        ...
        public void GetShoppingCart_ShouldReturnEmptyList_WhenNoVehiclesAdded()
        {
            ...
            // Assert: Verify that the shopping cart is empty
            Assert.Empty(cart);
        }
        ...
        public void Checkout_ShouldReturnCorrectTotal_AndClearCart()
        {
            ...
            // Create two vehicles to add to the inventory and cart
