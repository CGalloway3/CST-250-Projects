...
namespace MineSweeperClassLibrary.Tests
{
    public class MineSweeperLogicTests
    {
        ...
        public void BoardModelConstructor_CreatesProperSizeMatrix()
        {
            ...
            Assert.Equal(size, board.Cells.Length); // Rows
            Assert.Equal(size, board.Cells.Length); // Columns
            Assert.Equal(size * size, board.Cells.Length * board.Cells.Length); // Total cells
        }
        ...
        public void BoardLogic_Constructor_CreatesBoardModelInstance()
        {
            ...
            var boardField = typeof(MinesweeperClassLibrary.Services.BusinessLogicLayer.BoardLogic)
                .GetField("_boardModel", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            ...
            Assert.Equal(size * size, boardModel.Cells.Length * boardModel.Cells.Length);
        }
